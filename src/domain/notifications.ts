...
export const notificationInboxSchema = z.object({ items: z.array(notificationInboxItemSchema).max(25), page: z.number().int().min(1).max(1000), pageSize: z.literal(25) });
