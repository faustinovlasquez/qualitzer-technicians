...
function CommentsContent(props: CommentsTabProps) {
  ...
  return <View style={styles.stack}>
    <Card style={styles.stack}>
      ...
      {draft.error ? <View style={styles.tight}><Notice message={draft.error} tone="error" />{!draft.closed ? <Button title="Reintentar borrador" variant="secondary" disabled={draft.saving || draft.commentBusy || props.busy} onPress={() => { void retryDraft(); }} /> : null}</View> : null}
