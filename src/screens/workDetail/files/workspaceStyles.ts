...
export const workspaceStyles = StyleSheet.create({
  ...
  compactPicker: { flex: 1, minWidth: 0, minHeight: 56, flexDirection: "column", paddingHorizontal: 4, paddingVertical: 8, gap: 2 },
  compactPickerText: { minWidth: 0, fontSize: 13, lineHeight: 18 },
