...
const requiredSources = [
  ...
  "src/domain/userSignatures.ts",
  "src/infrastructure/signatureImage.ts",
  "src/screens/signatures/UserSignaturesPanel.tsx",
  "src/screens/signatures/SignatureEditor.tsx",
  "src/screens/orders/lifecycle/MaintenanceDeliveryDialog.tsx",
  "src/screens/orders/lifecycle/lifecycleRules.ts",
  "src/screens/orders/lifecycle/SignatureField.tsx",
